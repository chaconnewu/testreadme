# Awesome JavaScript [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d
7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/s
indresorhus/awesome)
...
_Host the javascript libraries and provide tools for fetching and packaging
them._
...
[amchart](http://www.amcharts.com/), [plotly](https://plot.ly/), and
...
Codepen](http://codepen.io/collection/HtAne/), and generators like
[Ajaxload](http://www.ajaxload.info/), [Preloaders](http://preloaders.net/)
and [CSSLoad](http://cssload.net/).
...
### Other
  ...
  * [list.js](https://github.com/javve/list.js) \- Adds search, sort, filters and flexibility to tables, lists and various HTML elements. Built to be invisible and work on existing HTML. http://www.listjs.com
...
## Video/Audio
  ...
  * [html5media](https://github.com/etianen/html5media) \- Enables  and  tags in all major browsers. <https://html5media.info/>
  ...
  * [flowplayer](https://github.com/flowplayer/flowplayer) \- The HTML5 video player for the web <https://flowplayer.org/>
  * [mediaelement](https://github.com/johndyer/mediaelement) \- HTML5  or  player with Flash and Silverlight shims that mimics the HTML5 MediaElement API, enabling a consistent UI in all browsers. <http://mediaelementjs.com/>
...
## Misc
  ...
  * [picturefill](https://github.com/scottjehl/picturefill) \- A responsive image polyfill for , srcset, sizes
...
[![CC0](http://i.creativecommons.org/p/zero/1.0/88x31.png)](http://creativecom
mons.org/publicdomain/zero/1.0/)

To the extent possible under law, [chencheng](https://github.com/sorrycc) has
